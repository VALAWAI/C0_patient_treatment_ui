...
/**
 * The service to publish a {@link TreatmentValueFeedbackPayload}.
 *
 * @author UDT-IA, IIIA-CSIC
 */
@ApplicationScoped
public class TreatmentValueFeedbackService {

	/**
	 * The component to send the treatment messages.
	 */
	@Channel("publish_treatment_value_feedback")
	@Inject
	 ...
	 */
	public void send(TreatmentValueFeedbackPayload feedback) {
